            ...
            <section className="py-6 bg-gray-100 text-gray-900">
                ...
                <section className="py-6 bg-gray-100 text-gray-900">
                    <div className="container grid grid-cols-2 gap-4 p-4 mx-auto md:grid-cols-4">
                        ...
                        <img alt="" className="w-full h-full rounded shadow-sm min-h-48 bg-gray-500 aspect-square" src="merch/Everyone.jpg" />
                        <img alt="" className="w-full h-full rounded shadow-sm min-h-48 bg-gray-500 aspect-square" src="merch/paddy_and_horse.jpg" />
                    </div>
                </section>
            </section>
            <Footer />
